    ...
    <>
      ...
      <nav className={styles.sidebar}>
        ...
        {(session.user.role === "admin" || session.user.role === "financial_officer") && (
          <>
            <Link href="/employees" className={pathname === "/employees" ? styles.active : ""}>
              Employees
            </Link>
            <Link href="/projects" className={pathname === "/projects" ? styles.active : ""}>
              Projects
            </Link>
            <Link href="/custom-accounts" className={pathname === "/custom-accounts" ? styles.active : ""}>
              Accounts
            </Link>
            <Link href="/bank" className={pathname === "/bank" ? styles.active : ""}>
              Bank/FD
            </Link>
          </>
        )}
